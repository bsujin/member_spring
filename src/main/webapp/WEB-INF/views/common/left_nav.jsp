...
<!-- Left navbar links -->
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp }/user/allUser" class="nav-link">HOME</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp }/user/userList"class="nav-link">회원관리</a></li>
			</ul>
