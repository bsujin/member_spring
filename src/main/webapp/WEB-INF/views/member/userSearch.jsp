					...
					<div class="card">
						<div class="card-header with-border">
							...
							<div id="keyword" class="card-tools" style="width: 550px;">
								<form id="search" action="${cp }/user/searchUser" method="get">
<!-- 									<input type="hidden" id="pages" name="pages" value="">  -->
<%-- 								<input type="hidden" id="searchT" name="searchType" value="${searchType }"> --%>
<%-- 								<input type="hidden" id="key" name="keyword" value="${keyword }"> --%>
										...
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item active"><a class="page-link"
													href="${cp }/user/searchUser?page=${i}&pageSize=${pageVo.pageSize }&searchType=${searchType}&keyword=${keyword}&ps=${ps}">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
